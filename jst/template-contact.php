...
<section class="inner contacts">
  <div class="wrapper">
    ...
    <?php $do_shortcode = '[contact-form-7 id="271" title="Для страницы контактов"]'; 
    $doShortCode = get_metadata('post', get_the_ID(), 'jst_contact_map', true );
    echo do_shortcode($do_shortcode); ?>
    <!-- <form action="#" class="inner__form log" id="popupOrder">
      ...
      <div class="log__wrap">
        <div class="log__group check">
          ...
          <label for="insight">Я ознакомился и согласен с <span><a href="#">Правилами пользования</a></span> и <span><a
...
<section class="map">
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2242.467066602709!2d37.581592916069305!3d55.80249139562584!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46b549fcd3aad429%3A0xae911a34e0878489!2z0JHRg9GC0YvRgNGB0LrQsNGPINGD0LsuLCA2Miwg0JzQvtGB0LrQstCwLCAxMjcwMTU!5e0!3m2!1sru!2sru!4v1534159137914"
