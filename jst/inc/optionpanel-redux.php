...
$opt_name = 'jst_options';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$help_tabs = array(
	array(
		'id'      => 'redux-help-tab-1',
		'title'   => esc_html__( 'Theme Information 1', 'jst' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'jst' ) . '</p>',
	),
	array(
		'id'      => 'redux-help-tab-2',
		'title'   => esc_html__( 'Theme Information 2', 'jst' ),
		'content' => '<p>' . esc_html__( 'This is the tab content, HTML is allowed.', 'jst' ) . '</p>',
	),
);
...
$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'jst' ) . '</p>';
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Global Settings', 'jst' ),
		'id'               => 'global-settings',
		'desc'             => esc_html__( 'Options for Header and Fotter', 'jst' ),
...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header Options', 'jst' ),
